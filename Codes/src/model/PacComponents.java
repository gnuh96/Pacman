...
public class PacComponents extends JComponent //component class for storing the Tanks, moving them at once
{	
	public static PacComponents gameInstance;
    ...
    public PacComponents() //in constructor variables are initialized
    {
    ...
    public static PacComponents getInstance() {
		return gameInstance;
	}
	...
	public static void setInstance(PacComponents pacComponents) {
		gameInstance = pacComponents;
	}
